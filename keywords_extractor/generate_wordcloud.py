...
def generate_phrase_wordcloud(topic_freq, output_filename='phrase_cloud', dpi=100, debug=False):
    # print(topic_freq)
    print("Generating phrase wordcloud!")
    wordcloud = WordCloud(width=1000, height=1000, scale=8, font_step=0.1, max_words=450, stopwords=None,
                          ...
                          mask=mask, relative_scaling=0.1, contour_color='blue',
...
def generate_keyword_wordcloud(keyword_freq, output_filename='keyword_cloud', dpi=150,  debug=False):
    ...
    wordcloud = WordCloud(width=1000, height=1000, scale=8, font_step=0.1,
                          ...
                          contour_width=10, collocations=False, normalize_plurals=False, color_func=custom_hex_color_func,
